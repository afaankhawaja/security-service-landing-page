...
export const ServiceExpertise = () => {
    ...
    return (
        <section
            ref={sectionRef}
            className="bg-[#e8e3df] py-24 px-6 relative overflow-hidden"
        >
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div ref={gridRef} className="grid grid-cols-2 gap-4">
                        {expertiseAreas.map((item, idx) => (
                            <div
                                key={idx}
                                className={`expertise-card opacity-0 p-8 border border-gray-200 flex flex-col items-center text-center group hover:bg-[#2E3350] transition-all duration-500 ${idx === 2 ? 'col-span-2' : ''}`}
                            >
